...
public class FactionLoader {
    ...
    private static void execute(@Nullable Event event) {
        ...
        while (true) {
            FactionFile = new File((FMLPaths.GAMEDIR.get().toString() + "/newaycore/factions/"), File.separator + ("faction_id_" + new java.text.DecimalFormat("##").format(CheckMultiplier) + ".json"));
