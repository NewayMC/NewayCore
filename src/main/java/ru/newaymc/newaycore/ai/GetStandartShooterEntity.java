...
public class GetStandartShooterEntity {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity == null)
            return;
        ShooterAIModule.execute(world, x, y, z, entity, entity instanceof StandartShooterEntity _datEntL8 && _datEntL8.getEntityData().get(StandartShooterEntity.DATA_CanBeCommander),
                entity instanceof StandartShooterEntity _datEntL8 && _datEntL8.getEntityData().get(StandartShooterEntity.DATA_CanBeInSquad),
                entity instanceof StandartShooterEntity _datEntI ? _datEntI.getEntityData().get(StandartShooterEntity.DATA_ammunation) : 0,
                ...
                entity instanceof StandartShooterEntity _datEntI ? _datEntI.getEntityData().get(StandartShooterEntity.DATA_shoot) : 0,
