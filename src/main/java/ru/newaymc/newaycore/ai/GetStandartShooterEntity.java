...
public class GetStandartShooterEntity {
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
        if (entity == null)
            return;
        ShooterAIModule.execute(world, x, y, z, entity, entity instanceof StandartShooterEntity _datEntI ? _datEntI.getEntityData().get(StandartShooterEntity.DATA_ammunation) : 0,
