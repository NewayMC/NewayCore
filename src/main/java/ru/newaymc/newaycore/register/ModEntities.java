...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<ShooterAiEntity>> SHOOTER_AI_ENTITY = register("shooter_ai_entity",
            EntityType.Builder.<ShooterAiEntity>of(ShooterAiEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).ridingOffset(-0.6f).sized(0.6f, 2f).eyeHeight(1.6f));
